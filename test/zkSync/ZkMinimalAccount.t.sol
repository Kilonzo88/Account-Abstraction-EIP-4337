...
contract ZkMinimalAccountTest is Test {
    ...
    function testZkOwnerCanExecuteCommands() public {
        ...
        Transaction memory transaction = _createUnsignedTransaction(minimalAccount.owner(), 113, destination, value, functionData);
    ...
    /*//////////////////////////////////////////////////////////////
                                HELPERS
    //////////////////////////////////////////////////////////////*/
    function _signedTransaction(Transaction memory transaction) view internal returns (Transaction memory){
    ...
    function _createUnsignedTransaction(
            ...
            return Transaction ({
                ...
                gasLimit: 16777212,
                gasPerPubdataByteLimit: 16777212,
                maxFeePerGas: 16777212,
                maxPriorityFeePerGas: 16777212,
                paymaster: 0,
                nonce: nonce,
                value: value,
